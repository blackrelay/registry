...
Invoke-Go @("run", "./cmd/br-indexer", "-mode", "derive-events", "-database-url", $DatabaseUrl, "-cycles", "current", "-module", "killmail,character,gate,assembly,storage_unit,turret", "-derive-batch-size", "5000")
