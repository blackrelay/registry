    ...
    (
      SELECT jsonb_agg(
        jsonb_build_object(
          ...
          'subjectEntityType', se.entity_type,
          'subjectDisplayName', coalesce(nullif(se.display_name, ''), se.name, ''),
          'predicate', r.predicate,
          'objectEntityId', r.object_entity_id,
          'objectEntityType', oe.entity_type,
          'objectDisplayName', coalesce(nullif(oe.display_name, ''), oe.name, ''),
